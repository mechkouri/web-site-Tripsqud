...
// les variable a executez dans la requete
 ...
 //le style et le contenue associer de confirmation d'email
    ...
    <span style="color:#05f7ff">TRIP</span>SQUAD</strong></center>
    </td>
    </tr>
    </table>
    </div><br>
    ...
    Pour tout changement ou annulation veuillez nous contacter via notre e-mail adresse<strong> tripsquad.officiel@gmail.com</strong></p>
    <p>Passez une tres bonne journée!</p>
    <p>Equipe<strong> TRIPSQUAD</strong></p>
...
$lien= 'http://localhost/TRIPSQUAD/SUBSCRIBE/inscription.php';
$header="MIME-Version: 1.0\r\n";
$header.='Content-Type:text/html; charset="UTF-8"'."\n";
$header.='Content-Transfer-Encoding: 8bit';
$message='
...
<br>
<p style="margin-left: 15px; margin-top: 12px;">Félicitations! Votre réservation est validée. Vous receverez bientôt une fiche d\'informations concernant le voyage.
Pour tout changement ou annulation veuillez nous contacter via notre e-mail adresse<strong> tripsquad.officiel@gmail.com</strong><br>
...
<body>
 ...
 <?php  if (isset($_SESSION['id']) ) :?>
  ...
  <input type="number" name="nombreP" id="name" placeholder="veuillez preciser le nombre" ><br>
...
<?php  else:?>
  ...
  <form id="register" action="" method="POST" onclick="ValidationForm2()">
    ...
    <input type="number" name="nombreP" id="name" placeholder="veuillez preciser le nombre" class="nombreP"><br>
...
<script type="text/javascript">
    ...
    var NombreDePersonnes = document.querySelector("input[name='nombreP']");
    ...
    function ValidationForm1(){
      ...
      function validation_numéro1(){
        ...
        if(!parseInt(NombreDePersonnes.value) && NombreDePersonnes.value <= 0 ){
    ...
    function ValidationForm2(){
      ...
      function validation_numéro2(){
        ...
        if(!parseInt(NombreDePersonnes2.value) && NombreDePersonnes2.value <= 0 ){
