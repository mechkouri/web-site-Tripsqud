...
if (empty($errors)){
  ...
  $insertion = $pdo->prepare("INSERT INTO clients SET prenom=?,nom=?,numéro_de_télé=?,ville=?,adresse=?,code_postal=?,email=?, mot_de_passe=?,sexe=?,confirmation=?");
  ...
  $lien =  "http://localhost/TRIPSQUAD/DB/confirme.php?id=$client_id&confirme=$confirme";
